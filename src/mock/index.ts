...
export const NOTIFICATIONS: AppNotification[] = [
  {
    id: 'n1',
    title: 'Google Meet: Live Mentor Session at 5:00 PM',
    body: 'Your 1-on-1 Career Coaching class with Mentor is scheduled for today at 5:00 PM IST. Tap to join your Google Meet room.',
    time: 'Today · 5:00 PM',
    read: false,
    kind: 'mentor',
    link: 'https://meet.google.com/aers-mentor-class',
  },
  {
    id: 'n2',
    title: 'Level 02 Active Stage: Find Your Strengths',
    body: 'You are currently on Level 02! Complete your scenario challenge to earn 3 stars and unlock Module 2.',
    time: '1h ago',
    read: false,
    kind: 'journey',
  },
  {
    id: 'n3',
    title: 'Placement Masterclass: Tech Interview Prep 🎓',
    body: 'Live interactive workshop on Data Structures & System Design tradeoffs is scheduled for Friday at 6:30 PM.',
    time: 'Yesterday',
    read: false,
    kind: 'session',
    link: 'https://meet.google.com/aers-masterclass',
  },
  {
    id: 'n4',
    title: 'Leaderboard Rank Up! 🚀',
    body: 'Congratulations! You earned +150 XP and climbed to Top 10 on the Student Leaderboard.',
    time: '2d ago',
    read: true,
    kind: 'system',
  },
  {
    id: 'n5',
    title: 'Employability Passport Milestone ⭐',
    body: 'Module 1 (Career Clarity) completed! Complete Level 08 (Verify Résumé) to claim your verified ATS Badge.',
    time: '3d ago',
    read: true,
    kind: 'journey',
  },
